...
public final class MovieContract implements BaseColumns {
    ...
    public static final String MOVIE_URI = "movies";
    ...
    public static final Uri CONTENT_URI =
            ContractBase.BASE_CONTENT_URI.buildUpon().appendPath(MOVIE_URI).build();

    public static final String CONTENT_TYPE =
            ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + ContractBase.CONTENT_AUTHORITY + "/" + MOVIE_URI;
    public static final String CONTENT_ITEM_TYPE =
            ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + ContractBase.CONTENT_AUTHORITY + "/" + MOVIE_URI;
    public static Uri buildMoviesUri(long id) {
        return ContentUris.withAppendedId(CONTENT_URI, id);
    }

    //content://CONTENT_AUTHORITY/movies/MovieId
